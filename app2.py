...
def query_EN(text):
    ...
    data = json.dumps({"prompt":f"{text} \nIntent:","max_tokens":50, "top_p":0.9,"temperature":0.95,"frequency_penalty": 0.3,"presence_penalty":1,"model":"davinci:ft-rct-studio:text-davinci-001-2022-04-15-08-21-56","stop":["\n"]})
...
name = "intent"  # 服务名字，要唯一,建议算法除了-之外，别加别的特殊符号
